    ...
    public partial class InitRepo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TopicsLikedId = table.Column<int>(type: "integer", nullable: false),
                    UserLikesId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserTopic", x => new { x.TopicsLikedId, x.UserLikesId });
                    table.ForeignKey(
                        name: "FK_AppUserTopic_AspNetUsers_UserLikesId",
                        column: x => x.UserLikesId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserTopic_Topics_TopicsLikedId",
                        column: x => x.TopicsLikedId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PostsLikedId = table.Column<int>(type: "integer", nullable: false),
                    UserLikesId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserPost", x => new { x.PostsLikedId, x.UserLikesId });
                    table.ForeignKey(
                        name: "FK_AppUserPost_AspNetUsers_UserLikesId",
                        column: x => x.UserLikesId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserPost_Posts_PostsLikedId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserPost_UserLikesId",
                table: "AppUserPost",
                column: "UserLikesId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserTopic_UserLikesId",
                table: "AppUserTopic",
                column: "UserLikesId");
