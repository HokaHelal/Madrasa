...
const routes: Routes = [
  ...
  { path: 'login', component: LoginComponent },
  {
    ...
    canActivate: [AuthGuard], component: ContentMainComponent,
    children: [
      { path: '', component: DashboardComponent },
      { path: 'dashboard', component: DashboardComponent },
      { path: 'class', component: ClassIntroComponent },
      ...
      {
        path: 'forums/section/:id', component: SectionPageComponent,
        resolve: { section: SectionResolver },
      },
      {
        path: 'forums/thread/:id', component: ThreadComponent,
        resolve: { topic: TopicResolver }, pathMatch: 'full',
      },
    ],
  },
];
